...
from train_utils import train_test_split, compute_accuracy, one_hot_encode, find_categorical_vars, k_percent_first_rows
...
_DATASET_MAP = {CATEGORICAL_DATA_X_FP: 'categorical',
...
if __name__ == "__main__":
    datasets = [(CATEGORICAL_DATA_X_FP, CATEGORICAL_DATA_Y_FP), (CONTINUOUS_DATA_X_FP, CONTINUOUS_DATA_Y_FP),
    ...
    for dataset_x, dataset_y in datasets:
        ...
        for _ in tqdm(range(REPEATS)):
            ...
            X_train_encoded_full, y_train_encoded_full, X_test_encoded, y_test_encoded = train_test_split(X=X_encoded,
                                                                                                          Y=y)
            for K in K_values:
                ...
                accuracy = compute_accuracy(predictions=predictions, actual_y=y_test_encoded.values.tolist())
